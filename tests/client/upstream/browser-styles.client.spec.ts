...
const css = readFileSync(fileURLToPath(new URL('../../../src/client/upstream/WorkspaceBrowser.module.css', import.meta.url)), 'utf8')
const rowsCss = readFileSync(fileURLToPath(new URL('../../../src/client/upstream/rows/Rows.module.css', import.meta.url)), 'utf8')
